...
- **PEPS Backend** (`docs/src/peps_backend.md`): User guide for the optional structured PEPS backend, examples, limitations, and benchmark scripts
- **SpinGlassPEPS Integration** (`docs/src/spinglasspeps_integration.md`): Architecture notes for the optional structured PEPS backend
